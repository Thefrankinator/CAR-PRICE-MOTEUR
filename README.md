...
Comparaison de 5 régressions, pipeline anti-fuite (preprocessing dans la CV),
cible en log. Modèle retenu : **XGBoost** (R² test ≈ 0,78, MAE ≈ 44k MAD).
→ Détails complets : [`D_modeling_README.md`](notebooks/D_modeling_README.md)
